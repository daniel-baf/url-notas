La exclusión mutua es un principio en sistema de concurrencia que garantiza, cuando un proceso accede a un recurso compartido, una variable de archivo que no afecte a otros mientras lo están utilizando.

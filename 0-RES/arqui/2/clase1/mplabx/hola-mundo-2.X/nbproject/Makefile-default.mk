...
FINAL_IMAGE=${DISTDIR}/hola-mundo-2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=pulsador.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/pulsador.o
POSSIBLE_DEPFILES=${OBJECTDIR}/pulsador.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/pulsador.o

# Source Files
SOURCEFILES=pulsador.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/hola-mundo-2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F4550
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/hola-mundo-2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/pulsador.o: pulsador.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/pulsador.o 
	${MP_AS} -mcpu=PIC18F4550 -c \
	-o ${OBJECTDIR}/pulsador.o \
	pulsador.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/hola-mundo-2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F4550 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/hola-mundo-2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
